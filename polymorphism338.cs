...
namespace Employee
{
    public abstract class Karyawan
    {
        ...
        private string nIK;
        public Karyawan(string Depan, string Belakang, string nik)
        {
            namaDepan = Depan;
        ...
        {
            return string.Format("{0} {1}\nNIK : {2}", NamaDepan, NamaBelakang, NIK);
        }
    ...
    public class GajiKaryawan : Karyawan
    {
        ...
        public GajiKaryawan(string Depan, string Belakang, string nik, decimal gaji)
            : base(Depan, Belakang, nik)
        {
            GajiMingguan = gaji;
        }
    ...
    public class KaryawanPerjam : Karyawan
    {
        ...
        public KaryawanPerjam(string Depan, string Belakang, string nik, decimal upahPerjam, decimal jamKerja)
            : base(Depan, Belakang, nik)
        {
            Upah = upahPerjam;
            Jam = jamKerja;
    ...
    public class KomisiKaryawan : Karyawan
    {
        ...
        public KomisiKaryawan(string Depan, string Belakang, string nik, decimal penjualan, decimal tingkat)
            : base(Depan, Belakang, nik)
        {
    ...
    public class KomisiTambahanKaryawan : KomisiKaryawan
    {
        ...
        public KomisiTambahanKaryawan(string Depan, string Belakang, string nik, decimal penjualan, decimal tingkat, decimal gaji)
            : base(Depan, Belakang, nik, penjualan, tingkat)
        {
            GajiPokok = gaji;
        }
